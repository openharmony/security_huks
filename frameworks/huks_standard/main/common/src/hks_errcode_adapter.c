...
static struct HksError g_errCodeTable[] = {
    {
        ...
        .oldErrCode = HKS_ERROR_NO_PERMISSION,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_INVALID_ARGUMENT,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_INSUFFICIENT_DATA,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_BUFFER_TOO_SMALL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_NULL_POINTER,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_PUBLIC_KEY,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_PRIVATE_KEY,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
            .errorMsg = "HKS_ERROR_INVALID_PRIVATE_KEY = -18",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_INVALID_KEY_INFO,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_HASH_NOT_EQUAL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
            .errorMsg = "HKS_ERROR_HASH_NOT_EQUAL = -20",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_PARAM_NOT_EXIST,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_NEW_ROOT_KEY_MATERIAL_EXIST,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_NONCE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_WRAPPED_FORMAT,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_AUTH_TYP_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_CHALLENGE_TYPE_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_ACCESS_TYPE_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_AUTH_TOKEN_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_TIME_OUT,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_AUTH_TYPE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_CHALLENGE_TYPE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_ACCESS_TYPE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_AUTH_TOKEN,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_SECURE_SIGN_TYPE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_ILLEGAL_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_API_NOT_SUPPORTED,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_NOT_SUPPORTED,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_USER_AUTH_TYPE_NOT_SUPPORT,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FEATURE_NOT_SUPPORTED,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_ALG_FAIL,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_KEY_SIZE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_PADDING_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_PURPOSE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_DIGEST_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_MODE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_AAD_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_IV_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_AE_TAG_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
            .errorMsg = "Check get ae failed. User should add ae in paramset.",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_CHECK_GET_SALT_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_CHECK_GET_ITERATION_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_MISSING_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_ALGORITHM,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_INVALID_KEY_SIZE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_PADDING,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_PURPOSE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_MODE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_DIGEST,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_SIGNATURE_SIZE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_IV,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_AAD,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_NONCE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_AE_TAG,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
            .errorMsg = "AE param is invalid. User should make sure using the correct value.",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_INVALID_SALT,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_ITERATION,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
        ...
        .oldErrCode = HKS_ERROR_INVALID_USAGE_OF_KEY,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INVALID_CRYPTO_ALG_ARGUMENT,
            .errorMsg = "Purpose param is invalid. User should make sure using the correct value.",
            .data = NULL
        ...
        .oldErrCode = HKS_ERROR_FILE_SIZE_FAIL,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_READ_FILE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_WRITE_FILE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_REMOVE_FILE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_OPEN_FILE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_CLOSE_FILE_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_MAKE_DIR_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_INVALID_KEY_FILE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_FILE_OPERATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_COMMUNICATION_FAILURE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_COMMUNICATION_FAIL,
            .errorMsg = "HKS_ERROR_COMMUNICATION_FAILURE = -9",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_IPC_MSG_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_COMMUNICATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_COMMUNICATION_TIMEOUT,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_COMMUNICATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_IPC_INIT_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_COMMUNICATION_FAIL,
        ...
        .oldErrCode = HKS_ERROR_IPC_DLOPEN_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_COMMUNICATION_FAIL,
            .errorMsg = "HKS_ERROR_IPC_DLOPEN_FAIL = -34",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_CRYPTO_ENGINE_ERROR,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_KEY_AUTH_PERMANENTLY_INVALIDATED,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_KEY_AUTH_VERIFY_FAILED,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_KEY_AUTH_TIME_OUT,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_SESSION_REACHED_LIMIT,
        .hksResult = {
        ...
        .oldErrCode = HKS_ERROR_NOT_EXIST,
        .hksResult = {
        ...
        .oldErrCode = HKS_FAILURE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "General error.",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_BAD_STATE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_INSUFFICIENT_MEMORY,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_STORAGE_FAILURE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_HARDWARE_FAILURE,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "HKS_ERROR_HARDWARE_FAILURE = -11",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_MALLOC_FAIL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_REQUEST_OVERFLOWS,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "HKS_ERROR_REQUEST_OVERFLOWS = -29",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_GET_USERIAM_SECINFO_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_GET_USERIAM_AUTHINFO_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "Calling useriam to get sec info failed.",
            .data = NULL
        ...
        .oldErrCode = HKS_ERROR_KEY_AUTH_FAILED,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "HKS_ERROR_KEY_AUTH_FAILED = -43",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_DEVICE_NO_CREDENTIAL,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "HKS_ERROR_DEVICE_NO_CREDENTIAL = -44",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_INVALID_OPERATION,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
            .errorMsg = "Memory copy failed.",
            .data = NULL
        }
    }, {
        .oldErrCode = HKS_ERROR_INTERNAL_ERROR,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_UNKNOWN_ERROR,
        .hksResult = {
            .errorCode = HUKS_ERR_CODE_INTERNAL_ERROR,
        ...
        .oldErrCode = HKS_ERROR_CREDENTIAL_NOT_EXIST,
        .hksResult = {
...
struct HksResult ConvertErrCode(int32_t ret) {
    ...
    for (; i < uErrCodeCount; ++i) {
        if (ret == g_errCodeTable[i].oldErrCode) {
