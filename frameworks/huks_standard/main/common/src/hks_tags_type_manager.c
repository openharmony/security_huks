...
const static uint32_t HKS_ALG_PARAMS_TAG[] = { HKS_ASSIGN_ALG_ENUM HKS_ASSIGN_INNER_TAG_ENUM };
const static uint32_t HKS_KEY_FILE_TAGS[] = { HKS_ASSIGN_KEY_FILE_ENUM };
