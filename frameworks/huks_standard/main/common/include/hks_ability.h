...
enum HksOperationType {
    ...
    HKS_OPERATION_FREE_CTX = 0x13,       /* free ctx */
    HKS_OPERATION_GET_MAIN_KEY = 0x14,   /* get root main key */
    HKS_OPERATION_FILL_RANDOM = 0x15,    /* fill random */
    HKS_OPERATION_HMAC = 0x16,
    HKS_OPERATION_HASH = 0x17,
    HKS_OPERATION_ENCRYPT = 0x18,
    HKS_OPERATION_DECRYPT = 0x19,
    HKS_OPERATION_BN_EXP_MOD = 0x1a,
};
...
#define HKS_CRYPTO_ABILITY_FREE_CTX(alg)        HKS_CRYPTO_ABILITY(HKS_OPERATION_FREE_CTX, alg)
