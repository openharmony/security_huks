...
#define HKS_ASSIGN_INNER_TMP_ENUM \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM5_BUFFER, HKS_TAG_TYPE_BYTES | 30026) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM0_INT32, HKS_TAG_TYPE_INT | 30027) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM6_BUFFER, HKS_TAG_TYPE_BYTES | 30032) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM7_BUFFER, HKS_TAG_TYPE_BYTES | 30033) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM8_BUFFER, HKS_TAG_TYPE_BYTES | 30034) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM9_BUFFER, HKS_TAG_TYPE_BYTES | 30035) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PARAM10_BUFFER, HKS_TAG_TYPE_BYTES | 30036) \
