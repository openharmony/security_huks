...
napi_value IsKeyExistAsyncWork(napi_env env, IsKeyExistAsyncContext &context)
{
    ...
    napi_status status{};
    do {
        status = napi_create_string_latin1(env, "isKeyExistAsyncWork", NAPI_AUTO_LENGTH, &resourceName);
        ...
        status = napi_create_async_work(env, nullptr, resourceName,
            ...
            [](napi_env env, napi_status status, void *data) {
                ...
                HksReturnKeyExistResult(env, napiContext->callback, napiContext->deferred, napiContext->result,
                    resultData);
