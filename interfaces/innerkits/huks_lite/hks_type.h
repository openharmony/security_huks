...
enum HksTag {
    ...
    // tag challenge
    HKS_TAG_CHALLENGE_NORMAL = HKS_TAG_TYPE_UINT | 314,
    HKS_TAG_CHALLENGE_0 = HKS_TAG_TYPE_UINT | 315,
    HKS_TAG_CHALLENGE_1 = HKS_TAG_TYPE_UINT | 316,
    HKS_TAG_CHALLENGE_2 = HKS_TAG_TYPE_UINT | 317,
    HKS_TAG_CHALLENGE_3 = HKS_TAG_TYPE_UINT | 318,
