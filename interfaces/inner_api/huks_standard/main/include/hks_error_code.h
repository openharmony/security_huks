 ...
 */
 enum HksErrorCode {
    ...
    /* 701 - 750 for SE ERROR */
    HKS_ERROR_SE_BASIC_NOT_AVAILABLE = -701,
    HKS_ERROR_SE_NOT_AVAILABLE = -702,
    HKS_ERROR_SE_OUT_OF_MEMORY = -703,
    HKS_ERROR_SE_ALG_NOT_SUPPORT = -704,
    HKS_ERROR_SE_TIME_OUT = -705,
    HKS_ERROR_SE_CMD_CALL_FAIL = -706,
    HKS_ERROR_SE_SHARED_MEM_WRITE_FAIL = -707,
    HKS_ERROR_SE_SHARED_MEM_READ_FAIL = -708,
    HKS_ERROR_SE_INVALID_MSPC_OUTPUT = -709,
    HKS_ERROR_SE_INVALID_HANDLE = -710,
    HKS_ERROR_SE_INVALID_SECURITY_LEVEL = -711,
    HKS_ERROR_SE_UNKNOWN_ERROR = -712,
