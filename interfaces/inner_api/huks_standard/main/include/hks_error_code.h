 ...
 */
 enum HksErrorCode {
    ...
    HKS_ERROR_PTHREAD_MUTEX_LOCK_FAIL = -153,
    HKS_ERROR_PTHREAD_MUTEX_UNLOCK_FAIL = -154,
    ...
    HKS_ERROR_DATA_NOT_EQUAL = -185,
    HKS_ERROR_SE_COUNT_EXCEED_LIMIT = -186,
    HKS_ERROR_SE_SESSION_EXCEED_LIMIT = -187,
    HKS_ERROR_SE_IMPORT_KEY_SE_LEVEL_MISMATCH = -188,
    HKS_ERROR_RPMB_UNAVAILABLE = -189,
    HKS_ERROR_RPMB_MAC_FAIL = 190,

    HKS_ERROR_UKEY_NOT_SYSTEM_APP = -294,
    HKS_ERROR_RESOURCE_INFO_MISSING = -295,
    HKS_ERROR_BUNDLE_NAME_MISSING = -296,
    ...
    HKS_ERROR_HANDLE_REACH_MAX_NUM = -335,
    HKS_ERROR_CODE_NETWORK_UNAVAILABLE = -336,
    HKS_ERROR_CODE_DCM_CALLBACK_ERROR = -337,
    ...
    HKS_ERROR_EXT_JS_METHOD_ERROR = -517,
    HKS_ERROR_EXT_RETURN_VALUE_INCORRECT = -518,
    HKS_ERROR_EXT_NAPI_FAILED = -519,

    HKS_ERROR_ENVELOP_BUILD_RSA_ECC_SM2_MATERIAL_FAIL = -520,
    HKS_ERROR_ENVELOP_BUILD_DH_22519_MATERIAL_FAIL = -521,

    /* 700 - 719 for SE environment ERROR */
    HKS_ERROR_SE_BASIC_NOT_AVAILABLE = -701,
    HKS_ERROR_SE_NOT_AVAILABLE = -702,
    HKS_ERROR_SE_CMD_CALL_FAIL = -703,
    HKS_ERROR_SE_BASIC_OUTPUT_LEN = -704,
    HKS_ERROR_SE_SHARED_MEM_WRITE_FAIL = -705,
    HKS_ERROR_SE_SHARED_MEM_READ_FAIL = -706,
    HKS_ERROR_SE_INVALID_MSPC_OUTPUT = -707,
    HKS_ERROR_SE_INVALID_HANDLE = -708,
    HKS_ERROR_SE_INVALID_SECURITY_LEVEL = -709,

    /* 720-799 for SE inner ERROR */
    HKS_ERROR_SE_INVALID_PARAM = -720,
    HKS_ERROR_SE_IO = -721,
    HKS_ERROR_SE_NULL = -722,
    HKS_ERROR_SE_ENCODE = -723,
    HKS_ERROR_SE_DECODE = -724,
    HKS_ERROR_SE_SET_PARAM = -725,
    HKS_ERROR_SE_GET_PARAM = -726,
    HKS_ERROR_SE_ADD_PARAM = -727,
    HKS_ERROR_SE_INVALID_TAG = -728,
    HKS_ERROR_SE_REPEAT_TAG = -729,
    HKS_ERROR_SE_MEMMOVE = -730,
    HKS_ERROR_SE_MEMCPY = -731,
    HKS_ERROR_SE_MEMSET = -732,
    HKS_ERROR_SE_NOT_FOUND = -733,
    HKS_ERROR_SE_NOT_SUPPORTED = -734,
    HKS_ERROR_SE_NO_PERMISSON = -735,
    HKS_ERROR_SE_MSIMATCH = -736,
    HKS_ERROR_SE_INVALID_ALGORITHM = -737,
    HKS_ERROR_SE_SKIP_ACCESS_CONTROL = -738,
    HKS_ERROR_SE_PARAM_NOT_EXIST = -739,
    HKS_ERROR_SE_CHECK_PURPOSE = -740,
    HKS_ERROR_SE_CHECK_DIGEST = -741,
    HKS_ERROR_SE_CHECK_MODE = -742,
    HKS_ERROR_SE_CHECK_DEVELOPER_ID = -743,
    HKS_ERROR_SE_CHECK_TOKEN_ID = -744,
    HKS_ERROR_SE_CHECK_ACCESS_GROUP = -745,
    HKS_ERROR_SE_CHECK_USER_ID = -746,
    HKS_ERROR_SE_CHECK_WRAP_TYPE = -747,
    HKS_ERROR_SE_CHECK_ACCESS_TOKEN_ID = -748,
    HKS_ERROR_SE_CHECK_KEY_FLAG = -749,
    HKS_ERROR_SE_CHECK_AUTH_TOKEN_VERSION = -750,
    HKS_ERROR_SE_CHECK_AUTH_TOKEN_CHALLENGE = -751,
    HKS_ERROR_SE_CHECK_AUTH_TOKEN_USER_ID = -752,
    HKS_ERROR_SE_CHECK_AUTH_TOKEN_USER_TYPE = -753,
    HKS_ERROR_SE_GET_PURPOSE = -754,
    HKS_ERROR_SE_GET_KEY = -755,
    HKS_ERROR_SE_GET_ALGORITHM = -756,
    HKS_ERROR_SE_GET_KEY_ACCESS_GROUP = -757,
    HKS_ERROR_SE_GET_DEVELOPER_ID = -758,
    HKS_ERROR_SE_GET_PROCESS_NAME = -759,
    HKS_ERROR_SE_GET_USER_ID = -760,
    HKS_ERROR_SE_GET_OWNER_ID = -761,
    HKS_ERROR_SE_GET_ACCESS_TOKEN_ID = -762,
    HKS_ERROR_SE_GET_KEY_INIT_CHALLENG = -763,
    HKS_ERROR_SE_GET_IF_NEED_APPEND_AUTH_INFO = -764,
    HKS_ERROR_SE_GET_APPEND_UPDATE_DATA = -765,
    HKS_ERROR_SE_ENCODE_RESP = -766,
    HKS_ERROR_SE_DECODE_CMD = -767,
    HKS_ERROR_SE_IO_LENGTH = -768,
    HKS_ERROR_SE_IO_CHANNEL = -769,
    HKS_ERROR_SE_P1P2 = -770,
    HKS_ERROR_SE_UNSUPPORT = -771,
    HKS_ERROR_SE_VERSION = -772,
    HKS_ERROR_SE_HMST_READ = -773,
    HKS_ERROR_SE_HMST_WRITE = -774,
    HKS_ERROR_SE_GET_AUTH_TOKEN = -775,
    HKS_ERROR_SE_GET_CHALLENGE_TYPE = -776,
    HKS_ERROR_SE_GET_AUTH_TIMEOUT = -777,
    HKS_ERROR_SE_GET_USER_AUTH_TYPE = -778,
    HKS_ERROR_SE_GET_KEY_AUTH_PURPOSE = -779,
    HKS_ERROR_SE_GET_KEY_AUTH_RESULT = -780,
    HKS_ERROR_SE_GET_USER_AUTH_ACCESS = -781,
    HKS_ERROR_SE_GET_DIGEST = -782,
    HKS_ERROR_SE_ADD_AUTH_TOKEN = -783,
    HKS_ERROR_SE_DEL_AUTH_TOKEN = -784,
    HKS_ERROR_SE_VERIFY = -785,

    HKS_ERROR_SE_UNKNOWN = -799,
