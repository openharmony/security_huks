...
#define HKS_ASSIGN_PARAM_ALG_ENUM \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_INCLUDE_UNIQUE_ID, HKS_TAG_TYPE_BOOL | 320) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_INVALIDATED_BY_ROOTING, HKS_TAG_TYPE_BOOL | 321) \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_ANONYMOUS_ATTESTATION_MODE, HKS_TAG_TYPE_UINT | 524) \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_CONTEXT, HKS_TAG_TYPE_BYTES | 528) \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PRIVACY_SEARCH, HKS_TAG_TYPE_BOOL | 1021) \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_ANCO_APP_UID, HKS_TAG_TYPE_BYTES | 10027) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_ANCO_CHALLENGE, HKS_TAG_TYPE_BYTES | 10028) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_ANCO_USER_ID, HKS_TAG_TYPE_UINT | 10029) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_PLAIN_TEXT, HKS_TAG_TYPE_BYTES | 10030) \
    HKS_ASSIGN_ENUM_VALUE(HKS_TAG_USER_AUTH_TYPE_ATL, HKS_TAG_TYPE_UINT | 10031) \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_UKEY_PIN, HKS_TAG_TYPE_BYTES | 200001) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_ABILITY_NAME, HKS_TAG_TYPE_BYTES | 200002) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_EXTRA_DATA, HKS_TAG_TYPE_BYTES | 200003) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_UID, HKS_TAG_TYPE_INT | 200004) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_PURPOSE, HKS_TAG_TYPE_INT | 200005) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_TIMEOUT, HKS_TAG_TYPE_UINT | 200006) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_RESOURCE_INFO, HKS_TAG_TYPE_BYTES | 200007) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_ABILITY_INFO, HKS_TAG_TYPE_BYTES | 200008) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_BUNDLE_NAME, HKS_TAG_TYPE_BYTES | 200009) \
