...
#define HKS_ASSIGN_PARAM_ALG_ENUM \
    ...
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_UKEY_PIN, HKS_TAG_TYPE_BYTES | 30001) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_ABILITY_NAME, HKS_TAG_TYPE_BYTES | 30002) \
    HKS_ASSIGN_ENUM_VALUE(HKS_EXT_CRYPTO_TAG_EXTRA_DATA, HKS_TAG_TYPE_BYTES | 30003) \
