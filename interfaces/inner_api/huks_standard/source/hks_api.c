...
HKS_API_EXPORT int32_t HksRefreshKeyInfo(void)
{
    ...
    HKS_IF_NOT_SUCC_LOGI(ret, "leave refresh key info, result = %" LOG_PUBLIC "d", ret);
    return ret;
#else
    ...
    const struct HksParamSet *paramSetIn, struct HksParamSet *paramSetOut)
{
    ...
    if ((ret == HKS_SUCCESS) && (storageFlag->uint32Param == HKS_STORAGE_TEMP)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave generate temp key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
    ...
    HKS_IF_NOT_SUCC_LOGI(ret, "leave %" LOG_PUBLIC "s, result = %" LOG_PUBLIC "d", __func__, ret);
    return ret;
#else
    (void)keyAlias;
    (void)paramSetIn;
    ...
    const struct HksBlob *srcData, const struct HksBlob *signature)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave verify with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
    ...
    const struct HksBlob *plainText, struct HksBlob *cipherText)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave encrypt with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
#ifndef _CUT_AUTHENTICATE_
    ...
    const struct HksBlob *cipherText, struct HksBlob *plainText)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave decrypt with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
#ifndef _CUT_AUTHENTICATE_
    ...
    const struct HksBlob *peerPublicKey, struct HksBlob *agreedKey)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave agree key with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
    ...
    struct HksBlob *derivedKey)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave derive key with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
#ifndef _CUT_AUTHENTICATE_
    ...
    const struct HksBlob *srcData, struct HksBlob *mac)
{
    ...
    if ((ret == HKS_SUCCESS) && (!isKeyAlias->boolParam)) {
        ...
        HKS_IF_NOT_SUCC_LOGI(ret, "leave mac with plain key, result = %" LOG_PUBLIC "d", ret);
        return ret;
    }
#ifndef _CUT_AUTHENTICATE_
...
HKS_API_EXPORT int32_t HksValidateCertChain(const struct HksCertChain *certChain, struct HksParamSet *paramSetOut)
{
    ...
    HKS_IF_NOT_SUCC_LOGI(ret, "leave validate cert chain, result = %" LOG_PUBLIC "d", ret);
    return ret;
#else
    (void)certChain;
    (void)paramSetOut;
