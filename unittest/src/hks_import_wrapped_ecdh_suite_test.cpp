...
namespace Unittest::ImportWrappedKey {
    class HksImportWrappedKeyTest2 : public testing::Test {
    public:
    ...
    void HksImportWrappedKeyTest2::SetUpTestCase(void) {
    }

    void HksImportWrappedKeyTest2::TearDownTestCase(void) {
    }

    void HksImportWrappedKeyTest2::SetUp() {
        EXPECT_EQ(HksInitialize(), 0);
    }

    void HksImportWrappedKeyTest2::TearDown() {
    }
    ...
    /**
     * @tc.name: HksImportWrappedKeyTest2.HksImportWrappedKeyTestEcdhSuite001
     ...
     * @tc.type: FUNC
     */
    HWTEST_F(HksImportWrappedKeyTest2, HksImportWrappedKeyTestEcdhSuite001, TestSize.Level0)
    {
    ...
    /**
     * @tc.name: HksImportWrappedKeyTest2.HksImportWrappedKeyTestEcdhSuite002
     ...
     * @tc.type: FUNC
     */
    HWTEST_F(HksImportWrappedKeyTest2, HksImportWrappedKeyTestEcdhSuite002, TestSize.Level0)
    {
    ...
    /**
     * @tc.name: HksImportWrappedKeyTest2.HksImportWrappedKeyTestEcdhSuite003
     ...
     * @tc.type: FUNC
     */
    HWTEST_F(HksImportWrappedKeyTest2, HksImportWrappedKeyTestEcdhSuite003, TestSize.Level0)
    {
