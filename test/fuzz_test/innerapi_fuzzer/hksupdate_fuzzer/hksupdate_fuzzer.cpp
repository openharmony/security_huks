...
int32_t DoSomethingInterestingWithMyAPI(FuzzedDataProvider &fdp)
{
    ...
    return HksUpdate(&handle, ps.s, &inData, &outData);
}

}}}

extern "C" int LLVMFuzzerInitialize(int *argc, char ***argv) {
    struct HksBlob aesAlias = { 15, reinterpret_cast<uint8_t *>(const_cast<char *>("fuzz_update_aes")) };
    ...
    printf("fuzz_update init: GenerateKey ret=%d\n", ret);
    ...
    printf("fuzz_update init: HksInit ret=%d\n", ret);
    ...
    printf("fuzz_update init: HksUpdate ret=%d\n", ret);
    return 0;
}
