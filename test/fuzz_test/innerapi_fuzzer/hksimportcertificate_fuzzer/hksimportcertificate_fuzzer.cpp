...
extern "C" int LLVMFuzzerInitialize(int *argc, char ***argv) {
    ...
    WrapParamSet importPs = BuildFixedParamSet({});
    int32_t ret = HksImportCertificate(&resourceId, &certInfo, importPs.s);
    printf("fuzz_importcertificate init: HksImportCertificate ret=%d\n", ret);
    return 0;
}
