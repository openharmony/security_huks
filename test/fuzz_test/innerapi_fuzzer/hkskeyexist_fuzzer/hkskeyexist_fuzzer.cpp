...
extern "C" int LLVMFuzzerInitialize(int *argc, char ***argv) {
    struct HksBlob rsaAlias = { 15, reinterpret_cast<uint8_t *>(const_cast<char *>("fuzz_exist_rsa")) };
    ...
    printf("fuzz_keyexist init: GenerateKey ret=%d\n", ret);

    ret = HksKeyExist(&rsaAlias, nullptr);
    printf("fuzz_keyexist init: HksKeyExist ret=%d\n", ret);
    return 0;
}
