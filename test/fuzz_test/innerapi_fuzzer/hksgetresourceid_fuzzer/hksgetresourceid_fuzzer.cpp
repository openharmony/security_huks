 ...
 */
#include "hksgetresourceid_fuzzer.h"
...
int DoSomethingInterestingWithHksGetResourceId(uint8_t *data, size_t size)
{
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    (void)OHOS::Security::Hks::DoSomethingInterestingWithHksGetResourceId(v.data(), v.size());
    return 0;
}
