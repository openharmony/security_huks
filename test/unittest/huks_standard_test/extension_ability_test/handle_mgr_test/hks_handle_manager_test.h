...
class MockHksProviderLifeCycleManager : public HksProviderLifeCycleManager {
public:
    MOCK_METHOD(int32_t, GetExtensionProxy, (const ProviderInfo& providerInfo, sptr<IHuksAccessExtBase>& proxy), (override));
    MOCK_METHOD(void, ReleaseExtensionProxy, (), (override));
};
