...
static const uint8_t g_nData1536[] = {
    
};

static const uint8_t g_dData1536[] = {
    
};
...
static const uint8_t g_pubData1536[] = {
    ,
};
...
static int32_t ConstructPubKey(uint32_t keySize, struct HksBlob *outKey)
{
    ...
    switch (keySize) {
        ...
        case HKS_RSA_KEY_SIZE_1024:
            ...
            break;
        case RSA_FLEX_KEY_SIZE_1536:
            pubDataBlob.size = sizeof(g_pubData1536);
            pubDataBlob.data = (uint8_t *)g_pubData1536;
            break;
...
static int32_t ConstructPriKeyParams(int32_t keySize, struct HksBlob *nDataBlob, struct HksBlob *dDataBlob)
{
    switch (keySize) {
        case HKS_RSA_KEY_SIZE_512:
        ...
        case HKS_RSA_KEY_SIZE_1024:
            ...
            break;
        case RSA_FLEX_KEY_SIZE_1536:
            nDataBlob->size = sizeof(g_nData1536);
            nDataBlob->data = (uint8_t *)g_nData1536;
            dDataBlob->size = sizeof(g_dData1536);
            dDataBlob->data = (uint8_t *)g_dData1536;
            break;
        case HKS_RSA_KEY_SIZE_2048:
...
static int32_t ConstructImportedKey(uint32_t keySize, uint32_t importType, struct HksBlob *outKey)
{
    ...
    int32_t ret = ConstructPriKeyParams(keySize, &nDataBlob, &dDataBlob);
    if (ret != HKS_SUCCESS) {
        return ret;
    }
...
#ifndef UNAVAILABLE_FOR_RSA_FLEX
/**
 * @tc.name: HksImportRsaTest.HksImportRsaTest010
 * @tc.desc: import rsa 1536-sign/verify-pss-sha256
 * @tc.type: FUNC normal
 */
HWTEST_F(HksImportRsaTest, HksImportRsaTest010, TestSize.Level0)
{
    ImportRsaPlainKeyTest(HKS_KEY_PURPOSE_SIGN | HKS_KEY_PURPOSE_VERIFY, RSA_FLEX_KEY_SIZE_1536,
        HKS_PADDING_PSS, HKS_DIGEST_SHA256);
}
#endif
#endif
