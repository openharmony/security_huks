...
const TestCaseParams HKS_CRYPTO_HAL_3DES_CIPHER_001_PARAMS = {
    .spec = {
...
#if defined(HKS_SUPPORT_3DES_C) && defined(HKS_SUPPORT_3DES_CBC_NOPADDING)
...
const TestCaseParams HKS_CRYPTO_HAL_3DES_CIPHER_002_PARAMS = {
    .spec = {
        .algType = HKS_ALG_3DES,
...
const TestCaseParams HKS_CRYPTO_HAL_3DES_CIPHER_003_PARAMS = {
    .spec = {
        .algType = HKS_ALG_3DES,
        .keyLen = HKS_3DES_KEY_SIZE_128,
        .algParam = nullptr,
    ...
    .hexData = "0011223344556677",
#if defined(HKS_SUPPORT_3DES_C) && defined(HKS_SUPPORT_3DES_ECB_NOPADDING)
    .generateKeyResult = HKS_SUCCESS,
    .encryptResult = HKS_SUCCESS,
    .decryptResult = HKS_SUCCESS,
#else
...
const TestCaseParams HKS_CRYPTO_HAL_3DES_CIPHER_004_PARAMS = {
    .spec = {
        .algType = HKS_ALG_3DES,
        .keyLen = HKS_3DES_KEY_SIZE_192,
        .algParam = nullptr,
...
const TestCaseParams HKS_CRYPTO_HAL_3DES_CIPHER_005_PARAMS = {
    .spec = {
        .algType = HKS_ALG_3DES,
        .keyLen = HKS_3DES_KEY_SIZE_128,
        .algParam = nullptr,
    ...
    .hexData = "0011223344556677",
#if defined(HKS_SUPPORT_3DES_C) && defined(HKS_SUPPORT_3DES_CTR_NOPADDING)
    .generateKeyResult = HKS_SUCCESS,
    .encryptResult = HKS_SUCCESS,
    .decryptResult = HKS_SUCCESS,
#else
...
class HksCryptoHal3DesCipher : public HksCryptoHalCommon, public testing::Test {
public:
...
void HksCryptoHal3DesCipher::SetUpTestCase(void)
{
}

void HksCryptoHal3DesCipher::TearDownTestCase(void)
{
}

void HksCryptoHal3DesCipher::SetUp()
{
    EXPECT_EQ(HksCryptoAbilityInit(), 0);
}

void HksCryptoHal3DesCipher::TearDown()
{
}

/**
 * @tc.number    : HksCryptoHal3DesCipher_001
 * @tc.name      : HksCryptoHal3DesCipher_001
 * @tc.desc      : Generate key and Encrypt / Decrypt 3DES-128-CBC-NOPADDING key.
 */
HWTEST_F(HksCryptoHal3DesCipher, HksCryptoHal3DesCipher_001, Function | SmallTest | Level0)
{
    RunTestCaseThreeStage(HKS_CRYPTO_HAL_3DES_CIPHER_001_PARAMS);
}

/**
 * @tc.number    : HksCryptoHal3DesCipher_002
 * @tc.name      : HksCryptoHal3DesCipher_002
 * @tc.desc      : Generate key and Encrypt / Decrypt 3DES-192-CBC-NOPADDING key.
 */
HWTEST_F(HksCryptoHal3DesCipher, HksCryptoHal3DesCipher_002, Function | SmallTest | Level0)
{
    RunTestCaseThreeStage(HKS_CRYPTO_HAL_3DES_CIPHER_002_PARAMS);
}

/**
 * @tc.number    : HksCryptoHal3DesCipher_003
 * @tc.name      : HksCryptoHal3DesCipher_003
 * @tc.desc      : Generate key and Encrypt / Decrypt 3DES-128-ECB-NOPADDING key.
 */
HWTEST_F(HksCryptoHal3DesCipher, HksCryptoHal3DesCipher_003, Function | SmallTest | Level0)
{
    RunTestCaseThreeStage(HKS_CRYPTO_HAL_3DES_CIPHER_003_PARAMS);
}

/**
 * @tc.number    : HksCryptoHal3DesCipher_004
 * @tc.name      : HksCryptoHal3DesCipher_004
 * @tc.desc      : Generate key and Encrypt / Decrypt 3DES-192-ECB-NOPADDING key.
 */
HWTEST_F(HksCryptoHal3DesCipher, HksCryptoHal3DesCipher_004, Function | SmallTest | Level0)
{
    RunTestCaseThreeStage(HKS_CRYPTO_HAL_3DES_CIPHER_004_PARAMS);
}

/**
 * @tc.number    : HksCryptoHal3DesCipher_005
 * @tc.name      : HksCryptoHal3DesCipher_005
 * @tc.desc      : 3DES-128-CTR-NOPADDING invalid mode not supported.
 */
HWTEST_F(HksCryptoHal3DesCipher, HksCryptoHal3DesCipher_005, Function | SmallTest | Level0)
{
    RunTestCaseThreeStage(HKS_CRYPTO_HAL_3DES_CIPHER_005_PARAMS);
}
}  // namespace UnitTest
}  // namespace Huks
}  // namespace Security
