...
HWTEST_F(HksNativeApiCompatibilityTest, HksNativeApiCompatibilityTest019, TestSize.Level0)
{
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_STORAGE_KEY_EXPORT_ALLOWED == (uint32_t)HKS_STORAGE_ALLOW_KEY_EXPORTED, true);
}
...
HWTEST_F(HksNativeApiCompatibilityTest, HksNativeApiCompatibilityTest022, TestSize.Level0)
{
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_ERR_CODE_KEY_ALREADY_EXIST == 12000017, true);
}
...
HWTEST_F(HksNativeApiCompatibilityTest, HksNativeApiCompatibilityTest035, TestSize.Level0)
{
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_TAG_DERIVED_AGREED_KEY_STORAGE_FLAG ==
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_TAG_KEY_OVERRIDE ==
        (uint32_t)HKS_TAG_KEY_OVERRIDE, true);
...
HWTEST_F(HksNativeApiCompatibilityTest, HksNativeApiCompatibilityTest036, TestSize.Level0)
{
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_TAG_DERIVED_AGREED_KEY_STORAGE_FLAG == (OH_HUKS_TAG_TYPE_UINT | 29), true);
...
{
    ASSERT_EQ((uint32_t)OH_HUKS_RSA_PSS_SALT_LEN_DIGEST == (uint32_t)HKS_RSA_PSS_SALTLEN_DIGEST, true);
    ASSERT_EQ((uint32_t)OH_HUKS_RSA_PSS_SALT_LEN_MAX == (uint32_t)HKS_RSA_PSS_SALTLEN_MAX, true);
}

/**
 * @tc.name: HksNativeApiCompatibilityTest073
 * @tc.desc: normal case to test native api(OHOS-NDK) compatibility:OH_Huks_Tag value compatibility
 */
HWTEST_F(HksNativeApiCompatibilityTest, HksNativeApiCompatibilityTest073, TestSize.Level0)
{
    ...
    ASSERT_EQ((uint32_t)OH_HUKS_TAG_KEY_OVERRIDE == (OH_HUKS_TAG_TYPE_BOOL | 520), true);
