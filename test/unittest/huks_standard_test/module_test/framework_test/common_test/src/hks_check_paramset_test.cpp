...
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest001");
...
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest002");
    struct HksParamSet *paramSet = NULL;
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest003
 * @tc.desc: tdd HksCoreCheckMacParams, make test with nonexist digest, expecting HKS_ERROR_CHECK_GET_DIGEST_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest003, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest003");
    struct HksParamSet *paramSet = NULL;
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest004
 * @tc.desc: tdd HksCoreCheckMacParams, make test with invalid digest, expecting HKS_ERROR_INVALID_DIGEST
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest004, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest004");
    struct HksParamSet *paramSet = NULL;
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest005
 * @tc.desc: tdd HksCoreCheckMacParams, make test with too small macBlob, expecting HKS_ERROR_BUFFER_TOO_SMALL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest005, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest005");
    struct HksParamSet *paramSet = NULL;
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest006
 * @tc.desc: tdd HksCoreCheckMacParams, make test with too small keyBlob, expecting HKS_ERROR_INVALID_KEY_SIZE
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest006, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest006");
    struct HksParamSet *paramSet = NULL;
    int32_t ret = BuildHksCoreCheckMacParamsTestParamSet(g_normalTag, g_normalTag, &paramSet);
    EXPECT_EQ(ret, HKS_SUCCESS) << "BuildHksCoreCheckMacParamsTestParamSet failed, ret = " << ret;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest007, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest007");
    struct HksParamSet *paramSet = NULL;
    int32_t ret = BuildHksCoreCheckMacParamsTestParamSet(g_normalTag, g_normalTag, &paramSet);
    EXPECT_EQ(ret, HKS_SUCCESS) << "BuildHksCoreCheckMacParamsTestParamSet failed, ret = " << ret;
    uint8_t macData2[g_sha256Len];
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest008
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with nonexist alg, expecting HKS_ERROR_CHECK_GET_ALG_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest008, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest008");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest009
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with invalid alg, expecting HKS_ERROR_INVALID_ALGORITHM
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest009, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest009");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest010
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with nonexist purpose, expecting
 *           HKS_ERROR_CHECK_GET_PURPOSE_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest010, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest010");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest011
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with invalid purpose, expecting
 *           HKS_ERROR_INVALID_PURPOSE
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest011, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest011");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest012
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with nonexist digest, expecting
 *           HKS_ERROR_CHECK_GET_DIGEST_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest012, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest012");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest013
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with invalid digest, expecting
 *           HKS_ERROR_INVALID_DIGEST
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest013, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest013");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest014
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with nonexist iteration, expecting
 *           HKS_ERROR_CHECK_GET_ITERATION_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest014, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest014");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest015
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with invalid iteration, expecting
 *           HKS_ERROR_INVALID_ITERATION
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest015, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest015");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest016
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with nonexist salt, expecting
 *           HKS_ERROR_CHECK_GET_SALT_FAIL
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest016, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest016");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest017
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with invalid salt, expecting
 *           HKS_ERROR_INVALID_SALT
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest017, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest017");
...
/**
 * @tc.name: HksFrameworkCommonCheckParamsetTest.HksFrameworkCommonCheckParamsetTest018
 * @tc.desc: tdd HksCoreCheckDeriveKeyParams, make test with correct params, expecting HKS_SUCCESS
 * @tc.type: FUNC
 */
HWTEST_F(HksFrameworkCommonCheckParamsetTest, HksFrameworkCommonCheckParamsetTest018, TestSize.Level0)
{
    HKS_LOG_I("enter HksFrameworkCommonCheckParamsetTest018");
