 ...
 * @tc.desc: tdd HksInsertClaim, with nullptr input, expect HKS_ERROR_INVALID_ARGUMENT
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksInsertClaim, with error data size, expect HKS_ERROR_BUFFER_TOO_SMALL
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksGetPublicKey, with null input, expect HKS_ERROR_INVALID_ARGUMENT
 * @tc.type: FUNC
 */
HWTEST_F(HksAttestUtilsTest, HksAttestUtilsTest003, TestSize.Level0)
{
    ...
    int32_t ret = HksGetPublicKey(nullptr, &info, &usageSpec);
    ret = HksGetPublicKey(&key, nullptr, &usageSpec);
    ret = HksGetPublicKey(&key, &info, nullptr);
 ...
 * @tc.desc: tdd HksGetPublicKey, with error alg type, expect HKS_ERROR_NOT_SUPPORTED
 * @tc.type: FUNC
 */
HWTEST_F(HksAttestUtilsTest, HksAttestUtilsTest004, TestSize.Level0)
{
    ...
    int32_t ret = HksGetPublicKey(&key, &info, &usageSpec);
 ...
 * @tc.desc: tdd HksGetPublicKey, with small key size in X25519, expect HKS_ERROR_INSUFFICIENT_MEMORY
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksGetPublicKey, with small key size in RSA, expect HKS_ERROR_INSUFFICIENT_MEMORY
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksGetPublicKey, with wrong key size for ECC, expect HKS_ERROR_NOT_SUPPORTED
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksGetPublicKey, get ECC public key which key size is 384 but total size is not equal with key size, expect HKS_ERROR_BUFFER_TOO_SMALL
 * @tc.type: FUNC
 */
 ...
 * @tc.desc: tdd HksGetPublicKey, get ECC public key which key size is 521 but total size is not equal with key size, expect HKS_ERROR_BUFFER_TOO_SMALL
 * @tc.type: FUNC
 */
