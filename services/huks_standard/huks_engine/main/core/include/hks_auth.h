...
enum HksAuthId {
	...
	HKS_AUTH_ID_CIPHER_SM4 = 0X5,
    HKS_AUTH_ID_MAC_HMAC = 0x6,
	HKS_AUTH_ID_MAC_SM3 = 0x7,
    HKS_AUTH_ID_DERIVE = 0x8,
    HKS_AUTH_ID_SIGN_VERIFY_DSA = 0x9,
    HKS_AUTH_ID_SIGN_VERIFY_ED25519 = 0x10,
    HKS_AUTH_ID_AGREE_X25519 = 0x11,
    HKS_AUTH_ID_AGREE_ECC = 0x12,
    HKS_AUTH_ID_AGREE_DH = 0x13,
	HKS_AUTH_ID_SIGN_VERIFY_SM2 = 0x14,
};
