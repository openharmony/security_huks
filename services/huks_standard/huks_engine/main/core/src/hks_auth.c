...
static uint32_t g_CipherSm4PolicyTag[] = { HKS_TAG_ALGORITHM, HKS_TAG_BLOCK_MODE, HKS_TAG_PADDING, HKS_TAG_PURPOSE };
...
static uint32_t g_signVerifyDsaPolicyTag[] = { HKS_TAG_ALGORITHM, HKS_TAG_DIGEST, HKS_TAG_PURPOSE };
...
static uint32_t g_agreeEccPolicyTag[] = { HKS_TAG_PURPOSE };
static uint32_t g_agreeX25519PolicyTag[] = { HKS_TAG_PURPOSE };
static uint32_t g_agreeDhPolicyTag[] = { HKS_TAG_PURPOSE };
...
struct HksAuthPolicy g_authPolicyList[] = {
    ...
    { HKS_AUTH_ID_CIPHER_SM4, HKS_ARRAY_SIZE(g_CipherSm4PolicyTag), g_CipherSm4PolicyTag },
    ...
    { HKS_AUTH_ID_SIGN_VERIFY_DSA, HKS_ARRAY_SIZE(g_signVerifyDsaPolicyTag), g_signVerifyDsaPolicyTag },
    ...
    { HKS_AUTH_ID_AGREE_ECC, HKS_ARRAY_SIZE(g_agreeEccPolicyTag), g_agreeEccPolicyTag },
    { HKS_AUTH_ID_AGREE_X25519, HKS_ARRAY_SIZE(g_agreeX25519PolicyTag), g_agreeX25519PolicyTag },
    { HKS_AUTH_ID_AGREE_DH, HKS_ARRAY_SIZE(g_agreeDhPolicyTag), g_agreeDhPolicyTag }
};
