...
static uint32_t g_signVerifyMlDsaPolicyTag[] = { HKS_TAG_ALGORITHM, HKS_TAG_PURPOSE };
...
struct HksAuthPolicy g_authPolicyList[] = {
    ...
    { HKS_AUTH_ID_SIGN_VERIFY_ML_DSA, HKS_ARRAY_SIZE(g_signVerifyMlDsaPolicyTag), g_signVerifyMlDsaPolicyTag },
