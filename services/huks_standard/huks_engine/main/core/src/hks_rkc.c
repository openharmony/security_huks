...
static int32_t RkcRecoverMkTime(const struct HksRkcKsfData *ksfData)
{
    ...
    do {
        ...
        ret = HksCryptoHalFillPriRandom(&mkMaskBlob);
...
static int32_t RkcCreateKsf(void)
{
    ...
    do {
        ...
        ret = HksCryptoHalFillPriRandom(&salt);
