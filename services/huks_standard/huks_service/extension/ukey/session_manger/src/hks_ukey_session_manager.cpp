...
{
    HKS_IF_TRUE_LOGE_RETURN(!CheckSingleCallerCanInitSession(*processAndError.processInfo), HKS_ERROR_SESSION_REACHED_LIMIT,
    ...
    ret = HksRemoteHandleManager::GetInstanceWrapper()->ParseAndValidateIndex(index, processAndError.processInfo->uidInt,
    ...
    HKS_IF_TRUE_LOGE_RETURN(!CheckAndAppendProcessInfo(newParamSet, *processAndError.processInfo), HKS_ERROR_INVALID_ARGUMENT,
