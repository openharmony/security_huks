...
public:
    ...
    uint32_t MSG_CODE_WRAP_KEY = HKS_MSG_WRAP_KEY;
    uint32_t MSG_CODE_UNWRAP_KEY = HKS_MSG_UNWRAP_KEY;
    uint32_t MSG_CODE_PROVISION = HKS_MSG_PROVISION;
    uint32_t MSG_CODE_PROVISION_VERIFY = HKS_MSG_PROVISION_VERIFY;
    uint32_t MSG_CODE_EXPORT_TRUST_CERTS = HKS_MSG_EXPORT_TRUST_CERTS;
