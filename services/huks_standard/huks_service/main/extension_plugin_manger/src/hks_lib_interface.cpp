    ...
    const std::string &providerName, const CppParamSet &paramSet)
{
    ...
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_REGISTER_PROVIDER, funcPtr);
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_UN_REGISTER_PROVIDER, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
    ...
    HKS_IF_TRUE_LOGE_RETURN(ret != HKS_SUCCESS, ret, "UnRegistProvider fail, ret = %{public}d", ret)
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_CREATE_REMOTE_INDEX, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
int32_t HuksLibInterface::OnCreateRemoteKeyHandle(const HksProcessInfo &processInfo,
    const std::string &index, const CppParamSet &paramSet, std::string &handle)
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_CREATE_REMOTE_KEY_HANDLE, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_CLOSE_REMOTE_KEY_HANDLE, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_AUTH_UKEY_PIN, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_GET_VERIFY_PIN_STATUS, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_CLEAR_PIN_STATUS, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_GET_REMOTE_PROPERTY, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
        "ClearPinStatus method enum not found in plugin provider map.")
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_LIST_INDEX_CERTIFICATE, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_LIST_PROVIDER_ALL_CERTIFICATE, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_INIT_SESSION, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_UPDATE_SESSION, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
...
{
    void *funcPtr = nullptr;
    bool isFindMethod = m_pluginProviderMap.Find(PluginMethodEnum::FUNC_ON_FINISH_SESSION, funcPtr);
    HKS_IF_TRUE_LOGE_RETURN(!isFindMethod, HKS_ERROR_FIND_FUNC_MAP_FAIL,
